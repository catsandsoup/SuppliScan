...
- Metadata, privacy answers, review notes, screenshot plans, and launch blockers are drafted here.
- Screenshots can be regenerated with `Tools/capture_app_store_screenshots.sh`.

Do not submit until:
- The OCR overhaul is complete and verified against real supplement labels.
